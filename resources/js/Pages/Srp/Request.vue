    ...
    <div class="bg-white overflow-hidden shadow sm:rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <form
          ...
          @submit.prevent="form.post(submitUrl)"
        >
              ...
              <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input
                      id="killmail"
                      v-model="form.killmailUrl"
                      name="killmail_url"
                      type="url"
                      placeholder="https://esi.evetech.net/latest/killmails/92281357/19c919549fbadsasdwe4fc7938b21f2965f1baf0/"
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                      Put the ping content related to the fleet where you loose this ship.
                    </p>
                  </div>
                </div>
              </div>
